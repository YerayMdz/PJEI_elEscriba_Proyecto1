...
public class InventoryUI : MonoBehaviour
{
    ...
    public AudioClip toggleInventorySound;   // Sonido al abrir/cerrar el inventario
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.I))
        {
            ...
            if (audioSource != null && toggleInventorySound != null)
            {
                audioSource.PlayOneShot(toggleInventorySound);
            }
        }
    }
}
